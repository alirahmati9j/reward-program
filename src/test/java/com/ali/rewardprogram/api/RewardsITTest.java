package com.ali.rewardprogram.api;

import com.ali.rewardprogram.config.BaseRestOAuthAwareIT;
import com.ali.rewardprogram.dto.OrderDTO;
import com.ali.rewardprogram.dto.PointsDTO;
import com.ali.rewardprogram.errorhandler.ErrorResponse;
...
public class RewardsITTest extends BaseRestOAuthAwareIT {
    ...
    public void calculateRewardWhenPurchase120() {
        ...
        orderDTO.setUsername("ali.rahmati");
    ...
    public void calculateRewardWhenUsernameIsInvalid() {
        ...
        OrderDTO orderDTO = new OrderDTO();
        orderDTO.setTotal(120.0);
        orderDTO.setUsername("ali.rahmati2");
    ...
    public void getTotalRewardsEarnedIn022022() {
        ...
        ResponseEntity<PointsDTO> responseEntityAsString =
                getRestTemplate().exchange(
                        createUriComponent("/reward?username=ali.rahmati&date=02-2022").toUriString(), HttpMethod.GET, request, PointsDTO.class);
